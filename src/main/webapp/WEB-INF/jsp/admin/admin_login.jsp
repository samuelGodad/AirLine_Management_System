            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/admnlog1.png"
                                 style="margin-top: 25%;">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s"
                                 src="img/admnlog2.png">
                        </div>
                        <div class="col-6 text-end">
                ...
                <div class="col-lg-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <form method="post" action="admin_login_servlet">
                            <div class="row g-3">
                                <h1 class="mb-4">Welcome to <span
                                        class="text-primary text-uppercase">Ethiopian Air Line</span></h1>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" id="adminpass" name="admin_pass"
