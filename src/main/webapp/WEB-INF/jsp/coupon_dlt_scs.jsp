  ...
  <body>
    <div class="container-xxl bg-white p-0">
      ...
      <div
        ...
        style="background-image: url(../../img/cpndlt.png)"
      >
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb justify-content-center text-uppercase">
                <li class="breadcrumb-item">
                  <a href="admin/admin_login_pass.jsp">Home</a>
                </li>
                <li
                ...
                <form method="post" action="dlt_coupon">
                  <div class="row g-3">
                    <h4 class="text-center text-primary text-uppercase">
                      ...
                      out.print(cname); %> , Coupon Deleted Successfully
                    </h4>
                    <h3 class="mb-4 text-center">
                      Delete Coupons<span class="text-primary text-uppercase">
                        <small>By Coupon Id</small></span
                      >
                    </h3>
                    <h6
                      class="text-start text-primary text-center text-uppercase"
                    >
                      <small>and Discount Offers</small>
                    </h6>
                    ...
                    <div class="col-md-4">
                      <select
                        class="form-select"
                        name="discoutnpercentage"
                        id="discoutnpercentage"
                      >
        ...
        <div class="container pb-5">
          <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <p class="mb-2">
                <i class="fa fa-phone-alt me-3"></i>+251 94 970 5277
              </p>
              <p class="mb-2">
          ...
          <div class="copyright">
            <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                ...
                <a class="border-bottom">Biniam,Samue,Fedasa</a>
              </div>
