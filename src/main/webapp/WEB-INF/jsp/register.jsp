                        ...
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s"
                                     src="img/rgstr1.png" style="margin-top: 25%;">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="registration">
                                <div class="row g-3">
                                    <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Ethiopian Air Line</span>
                                    </h1>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <select class="form-select" name="countryCode" id="countryCode">
                                                <option data-countryCode="IN" value="91" Selected>Ethiopia (+251)
                                                </option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="email" class="form-control" name="email_address"
                                                   id="email_address" placeholder="Enter Your Email">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit">New Registration
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The website and backend mechanism are designed and developed by <a
                                    class="text-dark fw-medium" href="https://www.facebook.com/AlphaTanmoy/">Tanmoy
                                Das</a> hope it's attractive and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="${pageContext.request.contextPath}/"> AirReserve </a>,
                            All Right Reserved. Designed By <a class="border-bottom">Tanmoy Das</a>
                        </div>
