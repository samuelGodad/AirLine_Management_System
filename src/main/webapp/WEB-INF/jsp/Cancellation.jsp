...
<!DOCTYPE html>
<html lang="en">
  <% String pagename="Cancellation.jsp"; session.setAttribute("pagename",
  pagename); %>
  <head>
    <meta charset="utf-8" />
              ...
              >
                ...
                >
                  <div class="navbar-nav mr-auto py-0">
                    ...
                    <a
                      href="availability_from_user_booking"
                      class="nav-item nav-link"
                      >Check Availability</a
                    >
                    <a href="booking" class="nav-item nav-link">Booking</a>
                    <a href="Cancellation" class="nav-item nav-link active"
                      >Cancellation</a
                    >
