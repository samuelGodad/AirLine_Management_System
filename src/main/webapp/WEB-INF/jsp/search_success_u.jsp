                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The website and backend mechanism are designed and developed by <a class="text-dark fw-medium" href="https://www.facebook.com/AlphaTanmoy/">Fedasa,Samuel,Biniam</a> hope it's attractive and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="../../index.jsp"> EthioAir </a>, All Right Reserved. Designed By <a class="border-bottom">Fedasa,Samuel,Biniam</a>
                        </div>
