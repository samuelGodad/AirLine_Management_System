...
<!DOCTYPE html>
<html lang="en">
  <% String pagename="payment_failed.jsp"; session.setAttribute("pagename",
  pagename); %>
  <head>
    <meta charset="utf-8" />
    ...
    <div class="container-xxl bg-white p-0">
      ...
      <div class="container-xxl py-5">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="mb-5">
            Payment <span class="text-primary text-uppercase">Failed</span>
          </h1>
          <h6 class="section-title text-center text-primary text-uppercase">
            ...
          </h6>
        ...
        <div class="container pb-5">
          <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <p class="mb-2">
                <i class="fa fa-envelope me-3"></i>ethioair.com
              </p>
