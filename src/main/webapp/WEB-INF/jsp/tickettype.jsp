            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">One-Way Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">Round-trip Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">First Class Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.11s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">Business Class Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.13s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">Coach Ticket</span></h1>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.17s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">Non-refundable tickets</span></h1>
                        <p class="mb-4">Round-trip tickets are tickets that allow the purchaser to travel to their destination and then back again. This type of ticket is for travelers who have plans to travel on specific dates.</p>
                    </div>
                    ...
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                        <h6 class="section-title text-start text-primary text-uppercase">Types Of Plane Tickets</h6>
                        <h1 class="mb-4">EthioAir Provides <span class="text-primary text-uppercase">Refundable ticket</span></h1>
