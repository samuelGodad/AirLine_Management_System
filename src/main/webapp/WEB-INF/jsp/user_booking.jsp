...
<!DOCTYPE html>
<html lang="en">
  <% String pagename="user_booking.jsp"; session.setAttribute("pagename",
  pagename); %>
  <head>
    <meta charset="utf-8" />
    ...
    <script>
      function payment_validate() {
        ...
        if (
          document.getElementById("payment_type").value === "Debit Card PAY"
        ) {
            ...
            <div class="row g-5">
              ...
              <div class="col-lg-6">
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                  <h3>
                    <small
                      >Your PNR No Is> <% String
                      pnrno=(String)session.getAttribute("pnrno");
                      out.print(pnrno); session.setAttribute("PNR",pnrno);
                      String
                      ticket_type=(String)session.getAttribute("ticket_type");
                  ...
                  <h3>
                    <small
                      >Your Total Fair: <% String
                      ff=(String)session.getAttribute("ff"); out.print(ff); %>
                    </small>
                  </h3>
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-6">
                        <div class="form-floating">
                          ...
                          >
                            ...
                            <option value="Debit Card PAY">
                              Debit Card PAY
                            </option>
                            <option value="Credit Card PAY">
                              Credit Card PAY
                            </option>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="form-floating">
                          <input
                            ...
                            class="form-control"
                            id="name"
                            placeholder="Provide Valid Coupon"
                            name="coupon"
                          />
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          ...
                          />
                          <label for="address"
                            >Enter UPI ID/ Credit Or Debit Card Number</label
                          >
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="form-floating">
                          <button
                            ...
                            onclick="return payment_validate();"
                            type="submit"
                          >
                            Pay Now
                          </button>
