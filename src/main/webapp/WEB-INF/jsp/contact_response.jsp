                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                The website and backend mechanism are designed and developed by <a class="text-dark fw-medium" href="https://www.facebook.com/AlphaTanmoy/">a team of Student</a> hope it's attractive and can be a demo of an actual airline system.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Contact</h6>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Samuel,Biniam,Fedasa</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+2519 82405 703</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>ethioair@gmail.com</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="../../index.jsp"> EthioAir </a>, All Right Reserved. Designed By <a class="border-bottom">Biniam,Fedasa,Samuel</a>
                        </div>
