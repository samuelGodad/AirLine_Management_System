...
<!DOCTYPE html>
<html lang="en">
  <% String pagename="Cancellation_failed.jsp"; session.setAttribute("pagename",
  pagename); %>
  <head>
    <meta charset="utf-8" />
              ...
              >
                ...
                >
                  <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="Cancellation.jsp" class="nav-item nav-link active"
                      >Cancellation</a
                    >
              ...
              <div class="row justify-content-center">
                <div class="col-lg-10 p-1">
                  <div class="text-center p-1">
                    <h3>
                      Sorry But The PNR NUMBER <% String
                      PNR=(String)session.getAttribute("PNR"); out.print(PNR);%>
                      IS IN-CORRECT
                    </h3>
                      ...
                      <div class="col-md-8">
                        <div class="form-floating">
                          <input
                            ...
                            class="form-control"
                            id="PNR"
                            placeholder="Provide Your PNR Number"
                            name="PNR"
                          />
        ...
        <div class="container pb-5">
          <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <p class="mb-2">
                <i class="fa fa-map-marker-alt me-3"></i>Baguihati, Brainware
              </p>
              <p class="mb-2">
                <i class="fa fa-phone-alt me-3"></i>+91 82405 70310
              </p>
              <p class="mb-2">
                <i class="fa fa-envelope me-3"></i>dtanmoy169@gmail.com
              </p>
          ...
          <div class="copyright">
            <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                &copy;
                <a class="border-bottom" href="../../index.jsp"> AirReserve </a
                >, All Right Reserved. Designed By
                <a class="border-bottom">Tanmoy Das</a>
              </div>
