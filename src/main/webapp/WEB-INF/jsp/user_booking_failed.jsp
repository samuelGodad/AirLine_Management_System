...
<!DOCTYPE html>
<html lang="en">
  <% String pagename="user_booking_failed.jsp"; session.setAttribute("pagename",
  pagename); %>
  <head>
    <meta charset="utf-8" />
    ...
    <div class="container-xxl bg-white p-0">
      ...
      <div class="container-xxl bg-white p-0">
              ...
              >
                ...
                >
                  <div class="navbar-nav mr-auto py-0">
                    <a href="user/user_login_pass.jsp" class="nav-item nav-link"
                      >Home</a
                    >
                    <a href="user_about.jsp" class="nav-item nav-link">About</a>
                    <a
                      href="availability_from_user_booking.jsp"
                      class="nav-item nav-link"
                      >Check Availability</a
                    >
                    <a href="booking.jsp" class="nav-item nav-link active"
                      >Booking</a
                    >
                    <a href="Cancellation.jsp" class="nav-item nav-link"
                      >Cancellation</a
                    >
                    <a href="contact_u.jsp" class="nav-item nav-link"
                      >Contact</a
                    >
                  </div>
                  <a
        ...
        <div
          ...
          style="background-image: url(../../img/booking.png)"
        >
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center text-uppercase">
                  <li class="breadcrumb-item">
                    <a href="user/user_login_pass.jsp">Home</a>
                  </li>
                  <li
        ...
        <div class="container-xxl py-5">
          <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
              ...
              <h1 class="mb-5">
                Book A
                <span class="text-primary text-uppercase">Plane Ticket</span>
              </h1>
            </div>
              ...
              <div class="col-lg-6">
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                  <form
                    name="m_f"
                    method="post"
                    action="user_booking_validation_check"
                  >
                    <div class="row g-3">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-floating">
                          <input
                            ...
                            class="form-control"
                            id="child"
                            placeholder="Total Number Of Child(s)"
                            name="child"
                          />
                      ...
                      <div class="col-12">
                        <div class="form-floating">
                          <button
                            ...
                            onclick="return booking_validate();"
                            type="submit"
                          >
                            Book Now
                          </button>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <i
                                  class="fa fa-question-circle fa-2x text-primary"
                                ></i>
                              </div>
                            </div>
                            <h5 class="mb-3">Plane Id?</h5>
                            <p class="text-body mb-0">
                              How To Get My Plane Id??
                            </p>
                          </a>
                        </div>
                      </div>
        ...
        <div class="container pb-5">
          <div class="row g-5">
            <div class="col-md-6 col-lg-4">
              <div class="bg-primary rounded p-4">
                ...
                <p class="text-white mb-0">
                  The website and backend mechanism are designed and developed
                  by
                  <a
                    class="text-dark fw-medium"
                    href="https://www.facebook.com/AlphaTanmoy/"
                    >Fedasa,Binaim,Fedasa</a
                  >
                  hope it's attractive and can be a demo of an actual airline
                  system.
                </p>
              </div>
            </div>
            <div class="col-md-6 col-lg-3">
              ...
              <p class="mb-2">
                <i class="fa fa-map-marker-alt me-3"></i>Addis Ababa,Ethiopia
             </p>
              <p class="mb-2">
                <i class="fa fa-phone-alt me-3"></i>+2519 82405 703
              </p>
              <p class="mb-2">
                <i class="fa fa-envelope me-3"></i>ethioair@gmai.com
              </p>
            ...
            <div class="col-lg-5 col-md-12">
              <div class="row gy-5 g-4">
                ...
                <div class="col-md-6">
                  ...
                  <a class="btn btn-link" href="user/user_login.jsp"
                    >Already a User</a
                  >
                  <a class="btn btn-link" href="user/user_register.jsp"
                    >New Registration</a
                  >
                  <a class="btn btn-link" href="admin/admin_login.jsp"
                    >Admin Login</a
                  >
                </div>
              </div>
          ...
          <div class="copyright">
            <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                &copy;
                <a class="border-bottom" href="../../index.jsp"> EthioAir </a
                >, All Right Reserved. Designed By
                <a class="border-bottom">Fedasa,Samuel,Biniam</a>
              </div>
