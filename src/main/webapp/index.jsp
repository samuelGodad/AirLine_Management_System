              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <h1 class="display-3 text-white mb-4 animated slideInDown">
                    Discover Your Dream Journey With Us
                  </h1>
                  <a
                    href="availability"
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                    >Plane Availability</a
                  >
                  <a
                    href="booking"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                    >Book Plane Tickets</a
                  >
                </div>
              </div>
            </div>
            <div class="carousel-item">
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  >
                    Coupon Code: abcdefgh05
                  </h6>
                  <h1 class="display-3 text-white mb-4 animated slideInDown">
                    Discover Huge Discounts On Plane Tickets
                  </h1>
                  <a
                    href=""
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                    >Get 5% Flat Discount</a
                  >
                  <button
                    id="copy1"
                    onclick="setClipboard('abcdefgh05')"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                  >
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <a
                    href=""
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                    >Get 10% Flat Discount</a
                  >
                  <button
                    id="copy4"
                    onclick="setClipboard('abcdefgh10')"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                  >
                    Copy Code To Clipboard
                  </button>
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <a
                    href=""
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                    >Get 15% Flat Discount</a
                  >
                  <button
                    id="copy2"
                    onclick="setClipboard('abcdefgh15')"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                  >
                    Copy Code To Clipboard
                  </button>
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <a
                    href=""
                    class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft"
                    >Get 25% Flat Discount</a
                  >
                  <button
                    id="copy3"
                    onclick="setClipboard('abcdefgh25')"
                    class="btn btn-light py-md-3 px-md-5 animated slideInRight"
                  >
                    Copy Code To Clipboard
                  </button>
        ...
        <div class="container">
          <div class="row g-5 align-items-center">
            <div class="col-lg-6">
              ...
              <h1 class="mb-4">
                Welcome to
                <span class="text-primary text-uppercase">EthioAir</span>
              </h1>
              <p class="mb-4">
                This is the demo system of Online Flight Booking methodology
                developed, designed and maintained by samuel,fedasa,biniam.
              </p>
              ...
              <a class="btn btn-primary py-3 px-5 mt-2" href="availability"
                >Explore More</a
              >
            </div>
            <div class="col-lg-6">
                ...
                <form method="post" action="GeneratePDF_from_PNR">
                  <div class="row g-3">
                    <h3 class="mb-4 text-center">
                      Search Details<span class="text-primary text-uppercase">
                        <small>By PNR Number</small></span
                      >
                    </h3>
                    <h6
                      class="text-start text-primary text-center text-uppercase"
                    >
                      <small>Search Your Details By PNR Number</small>
                    </h6>
      ...
      <div class="container-xxl py-5">
        <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">
              Explore Our
              <span class="text-primary text-uppercase">Planes</span>
            </h1>
          </div>
          <div class="row g-4">
                ...
                <div class="p-4 mt-2">
                  ...
                  <div class="d-flex mb-3">
                    <small class="border-end me-3 pe-3"
                      ><i class="fa fa-plane text-primary me-2"></i>Very
                      Comfortable</small
                    >
                    <small class="border-end me-3 pe-3"
                  ...
                  <p class="text-body mb-3">
                    First class tickets are a form of one-way or round-trip
                    tickets that allow travelers ...
                  </p>
              ...
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  ...
                  <div class="d-flex mb-3">
                    ...
                    >
                    <small class="border-end me-3 pe-3"
                      ><i class="fa fa-money-bill text-primary me-2"></i>Little
                      Costly</small
                    >
                    <small
                      ><i class="fa fa-glass-cheers text-primary me-2"></i
                  ...
                  <p class="text-body mb-3">
                    This type of ticket allows the purchaser to sit in business
                    class. It is a ticket that provides ...
                  </p>
                  <div class="d-flex justify-content-between">
                    <a
                      class="btn btn-sm btn-primary rounded py-2 px-4"
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="room-item shadow rounded overflow-hidden">
                ...
                <div class="p-4 mt-2">
                  ...
                  <p class="text-body mb-3">
                    Coach tickets are a type of ticket in which fliers travel in
          ...
          <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <a class="service-item rounded" href="">
                ...
                <p class="text-body mb-0">
                  Online airline booking sites allow users to search for flights
                  based on their preferred travel dates, destinations, and
                  budget..
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <a class="service-item rounded" href="">
                ...
                <p class="text-body mb-0">
                  These sites provide information on baggage allowances and fees
                  for each airline, so customers can plan accordingly.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <a class="service-item rounded" href="">
                ...
                <p class="text-body mb-0">
                  Online airline booking sites often provide real-time updates
                  on flight statuses, delays, and cancellations.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
              <a class="service-item rounded" href="">
                ...
                <p class="text-body mb-0">
                  Many online airline booking sites allow customers to select
                  their preferred seats during the booking process.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <a class="service-item rounded" href="">
                ...
                <p class="text-body mb-0">
                  Online airline booking sites display all fees and charges
                  upfront, so customers can make informed decisions about the
                  total cost of their flights.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
      ...
      >
        <div class="container">
          <div class="owl-carousel testimonial-carousel py-5">
            ...
            >
              <p>
                A good airline online booking website should have a clear and
                user-friendly interface that allows users to easily search for
                flights based on their travel dates, destination, and budget.
                The website should be easy to navigate, with clear menu options
                and search filters. This is the site.
              </p>
            ...
            >
              <p>
                The website should have a robust and efficient flight search
                engine that provides accurate and up-to-date information on
                available flights, schedules, and pricing. According to me this
                is best.
              </p>
              <div class="d-flex align-items-center">
                <img
            ...
            >
              <p>
                The website should offer a range of secure and convenient
                payment options, including credit cards, PayPal, and other
                electronic payment methods. This is best one!
              </p>
              <div class="d-flex align-items-center">
                <img
                  class="img-fluid flex-shrink-0 rounded"
      ...
      <div class="container-xxl py-5">
        <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">
              Explore Our
              <span class="text-primary text-uppercase">Co Leads</span>
            </h1>
          </div>
          <div class="row g-4">
